...
ActiveRecord::Schema.define(version: 20260913153501) do
  ...
  add_index "pins", ["procedure_id"], name: "index_pins_on_procedure_id", using: :btree
  add_index "pins", ["surgeon_id"], name: "index_pins_on_surgeon_id", using: :btree
  ...
  add_index "procedure_translations", ["locale", "name"], name: "index_procedure_translations_on_locale_and_name", using: :btree
  add_index "procedure_translations", ["procedure_id", "locale"], name: "index_procedure_translations_on_procedure_id_and_locale", unique: true, using: :btree
  ...
  add_index "procedures", ["slug"], name: "index_procedures_on_slug", unique: true, using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "never_signed_in_outreach_sent_at"
  end
