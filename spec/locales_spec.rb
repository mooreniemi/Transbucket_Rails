...
describe 'application locales' do
  ...
  REQUIRED_PUBLIC_PIN_KEYS = %w(doctor_prefix updated tap_to_reveal hide_image).freeze
  REQUIRED_PUBLIC_AUTH_KEYS = %w(username username_or_email password show_password hide_password have_account new_here password_hint).freeze
